...
| **[mend](https://github.com/Hritikd/mend)** | Repairs malformed JSON from LLMs into valid JSON — fences, single quotes, trailing commas, truncated output. Recovers 16/16 real-world defects vs stdlib's 0. | Python · CI | **[Live Demo](https://hritikd.github.io/mend/)** · [Code](https://github.com/Hritikd/mend) |
